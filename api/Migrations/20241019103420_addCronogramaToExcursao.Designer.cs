...
namespace api.Migrations
{
    ...
    [Migration("20241019103420_addCronogramaToExcursao")]
    partial class addCronogramaToExcursao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Excursao", b =>
                {
                    ...
                    b.Property<string>("local__destino")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("api.Models.Estabelecimento", b =>
                {
                    b.HasOne("api.Models.TipoEstabelecimento", "tipo_estabelecimento")
                        ...
                        .HasForeignKey("api.Models.Estabelecimento", "tipo_estabelecimento_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
